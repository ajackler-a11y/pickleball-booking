  ...
  <div className="nav-socials">
    ...
    <a href="https://www.instagram.com/pickleballhelpline/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M7 2C4.2 2 2 4.2 2 7v10c0 2.8 2.2 5 5 5h10c2.8 0 5-2.2 5-5V7c0-2.8-2.2-5-5-5H7zm10 2c1.7 0 3 1.3 3 3v10c0 1.7-1.3 3-3 3H7c-1.7 0-3-1.3-3-3V7c0-1.7 1.3-3 3-3h10zm-5 3a5 5 0 100 10 5 5 0 000-10zm0 2.5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm4.8-2.8a1 1 0 100 2 1 1 0 000-2z"/>
      </svg>
    </a>
    ...
    <a href="https://www.facebook.com/groups/pickleballhelplinecommunity" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M22 12a10 10 0 10-11.6 9.9v-7H8v-3h2.4V9.7c0-2.4 1.4-3.7 3.5-3.7 1 0 2 .2 2 .2v2.2h-1.1c-1.1 0-1.4.7-1.4 1.4V12H16l-.4 3h-2.3v7A10 10 0 0022 12z"/>
      </svg>
    </a>

    <a href="https://www.youtube.com/@thepickleballhelpline" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M23 7s-.2-1.5-.8-2.2c-.7-.8-1.5-.8-1.9-.9C17.7 3.5 12 3.5 12 3.5s-5.7 0-8.3.4c-.4 0-1.2.1-1.9.9C1.2 5.5 1 7 1 7S.8 8.8.8 10.6v1.7c0 1.8.2 3.6.2 3.6s.2 1.5.8 2.2c.7.8 1.7.8 2.1.9 1.5.1 6.1.4 8.1.4s5.7 0 8.3-.4c.4 0 1.2-.1 1.9-.9.6-.7.8-2.2.8-2.2s.2-1.8.2-3.6v-1.7C23.2 8.8 23 7 23 7zM9.8 14.6V8.9l5.6 2.8-5.6 2.9z"/>
      </svg>
    </a>

    <a href="https://www.tiktok.com/@pickleballhelpline" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2c1.1 0 2 .9 2 2v2.3c1.2 1 2.7 1.7 4.3 1.7v3.2c-1.7 0-3.3-.5-4.8-1.3v6.6c0 3.3-2.7 6-6 6S1.5 19.8 1.5 16.5 4.2 10.5 7.5 10.5c.5 0 1 .1 1.5.2v3.3c-.4-.2-.9-.3-1.5-.3-1.6 0-2.8 1.3-2.8 2.8S5.9 19.3 7.5 19.3 10.3 18 10.3 16.5V2H12z"/>
      </svg>
    </a>
  </div>
</nav>
 ...
 <h1>
  ...
  your pickleball game?
    ...
    <p className="hero-sub">
      We review your gameplay together so you can clearly see what’s going on and fix it.
    </p>

    <div className="hero-cta-group">
    <a href="#booking" className="btn-primary">
      Get My Game Reviewed <span>→</span>
    </a>
    ...
    <div className="hero-testimonial">
      ...
      <div className="hero-testimonial-text">
        <p className="hero-testimonial-quote">
          “I recognized habits I didn't even know I had.”
        </p>
...
<section id="how-it-works" className="how-it-works">
  ...
  <div className="cards">
    <div className="card">
      ...
      <p>Film one full game on your phone and send me the link.
         No editing needed.</p>
    </div>
    <div className="card">
      <h3>2. We Review It Together</h3>
      <p>We review your footage live on a 45-minute call.
        Pause key moments and clearly see what’s actually happening.
      </p>
    </div>
    <div className="card">
      <h3>3. Get Your Action Plan</h3>
      <p>You leave with clear takeaways and what to focus on next.
         Plus drills you can start using right away.</p>
    </div>
  </div>
</section>
  ...
  <div className="testimonials-grid">
    <div className="testimonial">
      <p className="testimonial-text">
        AJ pauses at key moments, and explains the small adjustments that make a big difference.
      </p>
    ...
    <div className="testimonial">
      <p className="testimonial-text">
        The follow-up summary and suggested drills made it really easy to turn those insights into real improvement.
      </p>
      <div className="testimonial-footer">
    ...
    <div className="testimonial">
      <p className="testimonial-text">
        Seeing the footage slowed down made everything clear.
      </p>
      <div className="testimonial-footer">
        <img src="/lille.png" alt="Brigitte D." className="testimonial-photo" />
...
<p className="coach-credentials">
  ...
  With over 25 years in the health and fitness industry, AJ is a PPR Certified Coach and Smash Dink Instructor who combines technique, strategy, and mindset — and loves that moment when it finally clicks for a player.
</p>

<p className="coach-brand-line">
  Have a question before you book?
</p>

        <a href="mailto:aj@thepickleballhelpline.com" className="coach-email">
          aj@thepickleballhelpline.com
        </a>
      </div>
    </div>
  </div>
